# Getting help with ggfancy

Thanks for using ggfancy. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/ggfancy/issues) to make sure the 
